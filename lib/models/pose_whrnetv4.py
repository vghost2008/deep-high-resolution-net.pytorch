...
class PoseHighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        # stem net
        if extra['FIRST_CONV_NR'] == 2:
            print(f"Useg small kernel stem.")
            ...
            print(f"Useg big kernel stem.")
            self.conv1 = nn.Conv2d(3, 64, kernel_size=6, stride=6, padding=0,
                                   bias=False)
            self.bn1 = nn.BatchNorm2d(64, momentum=BN_MOMENTUM)
            self.conv2 = None
            self.bn2 = None
        ...
        last_channels = pre_stage_channels[0]
    ...
    def init_weights(self, pretrained=''):
        ...
        if os.path.isfile(pretrained):
            ...
            forgiving_state_restore(self,need_init_state_dict,verbose=True)
